...
#ifdef DX8_VOLUMETEXTURE
#define FORMAT_VOLUME_TEX D3DFORMAT_OP_VOLUMETEXTURE
#else
#define FORMAT_VOLUME_TEX 0
#endif
...
static DDPIXELFORMAT myTextureFormatsDX8[] =
{
	...
	DX8_FORMAT(D3DFMT_A8R8G8B8,
			...
			FORMAT_VOLUME_TEX,
		D3DMULTISAMPLE_NUM_SAMPLES),
	DX8_FORMAT(D3DFMT_R8G8B8,
			D3DFORMAT_OP_TEXTURE |
			D3DFORMAT_OP_CUBETEXTURE |
			FORMAT_VOLUME_TEX,
		0),
	DX8_FORMAT(D3DFMT_R3G3B2,
			D3DFORMAT_OP_TEXTURE |
			D3DFORMAT_OP_CUBETEXTURE |
			FORMAT_VOLUME_TEX,
		0),
	DX8_FORMAT(D3DFMT_X4R4G4B4,
			D3DFORMAT_OP_TEXTURE |
			D3DFORMAT_OP_CUBETEXTURE |
			FORMAT_VOLUME_TEX,
		0),
	DX8_FORMAT(D3DFMT_A8,
			D3DFORMAT_OP_TEXTURE |
			D3DFORMAT_OP_CUBETEXTURE |
			FORMAT_VOLUME_TEX,
		0),
	DX8_FORMAT(D3DFMT_L8,
			D3DFORMAT_OP_TEXTURE |
			D3DFORMAT_OP_CUBETEXTURE |
			FORMAT_VOLUME_TEX,
		0),
	DX8_FORMAT(D3DFMT_A8L8,
			D3DFORMAT_OP_TEXTURE |
			D3DFORMAT_OP_CUBETEXTURE |
			FORMAT_VOLUME_TEX,
		0),
	DX8_FORMAT(D3DFMT_DXT1,
			D3DFORMAT_OP_TEXTURE |
			D3DFORMAT_OP_CUBETEXTURE |
			FORMAT_VOLUME_TEX,
		D3DMULTISAMPLE_NUM_SAMPLES),
	DX8_FORMAT(D3DFMT_DXT2,
			D3DFORMAT_OP_TEXTURE |
			D3DFORMAT_OP_CUBETEXTURE |
			FORMAT_VOLUME_TEX,
		D3DMULTISAMPLE_NUM_SAMPLES),
	DX8_FORMAT(D3DFMT_DXT3,
			D3DFORMAT_OP_TEXTURE |
			D3DFORMAT_OP_CUBETEXTURE |
			FORMAT_VOLUME_TEX,
		D3DMULTISAMPLE_NUM_SAMPLES),
	DX8_FORMAT(D3DFMT_DXT4,
			D3DFORMAT_OP_TEXTURE |
			D3DFORMAT_OP_CUBETEXTURE |
			FORMAT_VOLUME_TEX,
		D3DMULTISAMPLE_NUM_SAMPLES),
	DX8_FORMAT(D3DFMT_DXT5,
			D3DFORMAT_OP_TEXTURE |
			D3DFORMAT_OP_CUBETEXTURE |
			FORMAT_VOLUME_TEX,
		D3DMULTISAMPLE_NUM_SAMPLES),
...
#define MYVERTEXPROCCAPS_DX8 (MYVERTEXPROCCAPS|D3DVTXPCAPS_TEXGEN_SPHEREMAP)
