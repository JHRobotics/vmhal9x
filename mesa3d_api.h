...
MESA_API(glTexSubImage2D, void, (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pixels))
...
MESA_API(glGenerateMipmap, void, (GLenum target))
MESA_API(glHint, void, (GLenum target, GLenum mode))
